...
CREATE TABLE `tbl_admin` (
  ...
  `fld_username` varchar(10) NOT NULL,
  `fld_name` varchar(64) NOT NULL,
  `fld_password` varchar(128) NOT NULL,
  `fld_desg` varchar(30) NOT NULL,
...
INSERT INTO `tbl_admin` (`fld_uid`, `fld_username`, `fld_name`, `fld_password`, `fld_desg`, `fld_address`, `fld_photo`) VALUES
(1, 'admin', 'Aziz', 'admin', 'Boss', 'Savar', '');
...
CREATE TABLE `tbl_district` (
  `fld_id` int(2) UNSIGNED NOT NULL,
  `fld_division_id` int(2) UNSIGNED NOT NULL,
  `fld_name` varchar(30) NOT NULL,
  `fld_bn_name` varchar(50) NOT NULL,
  `fld_lat` double NOT NULL,
  `fld_lon` double NOT NULL,
  `fld_website` varchar(100) NOT NULL
...
INSERT INTO `tbl_district` (`fld_id`, `fld_division_id`, `fld_name`, `fld_bn_name`, `fld_lat`, `fld_lon`, `fld_website`) VALUES
...
INSERT INTO `tbl_division` (`fld_id`, `fld_name`, `fld_bn_name`) VALUES
(1, 'Barisal', 'বরিশাল'),
...
CREATE TABLE `tbl_organization` (
  `fld_uid` int(11) NOT NULL,
  `fld_orgname` varchar(64) NOT NULL,
  `fld_address` varchar(128) NOT NULL,
  `fld_details` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_unions` (
  `fld_id` int(2) UNSIGNED NOT NULL,
  `fld_upazila_id` int(2) UNSIGNED NOT NULL,
  `fld_name` varchar(30) NOT NULL,
  `fld_bn_name` varchar(50) NOT NULL,
  `fld_lat` double NOT NULL,
  `fld_lon` double NOT NULL
...
INSERT INTO `tbl_unions` (`fld_id`, `fld_upazila_id`, `fld_name`, `fld_bn_name`, `fld_lat`, `fld_lon`) VALUES
(1, 226, '', 'আমলাব', 0, 0),
(2, 226, '', 'বাজনাব', 0, 0),
(3, 226, '', 'বেলাব', 0, 0),
...
CREATE TABLE `tbl_upazila` (
  `fld_id` int(2) UNSIGNED NOT NULL,
  `fld_district_id` int(2) UNSIGNED NOT NULL,
  `fld_name` varchar(30) NOT NULL,
  `fld_bn_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_upazila` (`fld_id`, `fld_district_id`, `fld_name`, `fld_bn_name`) VALUES
...
CREATE TABLE `tbl_userinfo` (
  ...
  `fld_designation` varchar(64) NOT NULL,
  `fld_organization` varchar(100) NOT NULL,
  `fld_status` int(2) NOT NULL,
  `fld_address` varchar(128) NOT NULL,
  `fld_ward` int(2) NOT NULL,
  `fld_village` varchar(30) NOT NULL,
  `fld_up` varchar(30) NOT NULL,
  `fld_ps` varchar(30) NOT NULL,
  `fld_division` varchar(64) NOT NULL,
  `fld_photo` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `tbl_district`
  ...
  ADD KEY `fld_division_id` (`fld_division_id`);
...
ALTER TABLE `tbl_unions`
  ADD PRIMARY KEY (`fld_id`),
  ADD KEY `fld_upazila_id` (`fld_upazila_id`);
...
ALTER TABLE `tbl_upazila`
  ADD PRIMARY KEY (`fld_id`),
  ADD KEY `fld_district_id` (`fld_district_id`);
...
--
ALTER TABLE `tbl_unions`
  ADD CONSTRAINT `unions_ibfk_1` FOREIGN KEY (`fld_upazila_id`) REFERENCES `tbl_upazila` (`fld_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_upazila`
--
ALTER TABLE `tbl_upazila`
